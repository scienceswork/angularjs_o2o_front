...
angular.module('webFrontApp')
  .config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
    ...
    // 测试页面
      ...
      .state('address', {
        url: '/address',
        templateUrl: 'views/profile/address/address.html',
      ...
      .state('addressAdd', {
        url: '/addressAdd',
        templateUrl: 'views/profile/address/addressAdd.html',
      ...
      .state('haou.itemInfo', {
        url: '/itemInfo',
        templateUrl: 'views/haou/itemInfo/itemInfo.html',
        controller: 'haouItemInfoCtrl',
        controllerAs: 'vm'
      })
      // haou官网店商品图文信息
